...
public class AccountsPage {
    ...
    public void navigateToAccountDetails() {
        try {
            ...
            appiumUtils.waitForElementByText(Locators.ACCOUNTS_TEXT, 20);
            appiumUtils.clickByText(Locators.ACCOUNTS_TEXT);
            appiumUtils.clickById(Locators.ACCOUNT_DROPDOWN);
            appiumUtils.clickByText(Locators.ACCOUNT_DETAILS_TEXT);
